...
of_SetAppKey ( "HKEY_LOCAL_MACHINE\Software\Sybase\PowerBuilder\" + &
	String ( li_major ) + "." + String ( li_minor ) + "\PFC Examples" )

// User registry key
of_SetUserKey ( "HKEY_CURRENT_USER\Software\Sybase\PowerBuilder\" + &
	String ( li_major ) + "." + String ( li_minor ) + "\PFC Examples" )
...
// Initialize SQLCA
SQLCA.DBMS 		= "ODBC"
SQLCA.DBParm 	= "ConnectString='DSN=EAS Demo DB V105;UID=dba;PWD=sql',DelimitIdentifier='Yes'"
